  ...
  return(
    <div className={styles.main}>
      ...
      <div className={styles.button}>
        ...
        <div className={`${styles.divt1} ${styles.submain}`}>
        <table className={`${styles.divt1} ${styles.table}`}>
          <tbody>
            ...
            <tr>
              <td className={`${styles.cell} ${styles.textboldice}`}><Image src="/ice1.jpg" alt="Vercel Logo" width={40} height={30} /></td>
              <td className={`${styles.cell} ${styles.textboldice}`}>2.7 Packaged Ice</td>
              <td className={`${styles.cell} ${styles.textboldice}`}>$3.75</td>
              <td className={`${styles.cell} ${styles.textboldice}`}>
              <div className={styles.divminusplus}>
              <p className={styles.spanborder}>
      ...
      <table className={styles.table}>
        <tbody>
          ...
          <tr>
            <td className={`${styles.cell} ${styles.textbolddis} ${styles.left}`}>Cart Total:</td>
            <td className={`${styles.cell} ${styles.textbolddis} ${styles.center}`}>$84.15</td>
            <td className={`${styles.cell} ${styles.textbolddis} ${styles.right}`}></td>
          </tr>
        </tbody>
      </table>
      </div>
